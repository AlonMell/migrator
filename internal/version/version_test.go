...
func TestVersion_String(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "large numbers",
			version:  version.New(99, 99, 9999),
			expected: "99.99.9999",
		},
	}
...
func TestVersion_CompareTo(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			version2: version.New(1, 5, 10),
			expected: 1,
		},
		{
			name:     "lower major version",
			version1: version.New(1, 5, 10),
		...
		},
		{
			...
			version2: version.New(1, 2, 10),
			expected: 1,
		},
		{
			name:     "equal major, lower minor version",
			version1: version.New(1, 2, 10),
			version2: version.New(1, 3, 0),
			expected: -1,
		},
		{
...
// 	for _, tt := range tests {
// 		t.Run(tt.name, func(t *testing.T) {
// 			version, err := migrator.ParseVersionFromFilename(tt.filename)
...
// 	for _, tt := range tests {
// 		t.Run(tt.name, func(t *testing.T) {
// 			comment := migrator.GetCommentFromFilename(tt.filename)
...
// 	for _, tt := range tests {
// 		t.Run(tt.name, func(t *testing.T) {
// 			result := migrator.IsUpMigration(tt.filename)
// 			assert.Equal(t, tt.expected, result)
// 		})
// 	}
// }
...
// 	for _, tt := range tests {
// 		t.Run(tt.name, func(t *testing.T) {
// 			result := migrator.IsDownMigration(tt.filename)
// 			assert.Equal(t, tt.expected, result)
// 		})
// 	}
// }
...
// 	for _, tt := range tests {
// 		t.Run(tt.name, func(t *testing.T) {
// 			result := migrator.GetBaseName(tt.filename)
// 			assert.Equal(t, tt.expected, result)
// 		})
// 	}
// }
